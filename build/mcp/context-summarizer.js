...
exports.ContextSummarizer = void 0;
class ContextSummarizer {
     ...
     */
    needsSummarization(messages, systemPrompt) {
        ...
        return (messages.length >= this.config.minMessagesToSummarize &&
    ...
    extractKeyInformation(messages) {
        ...
        messages.forEach(msg => {
            ...
            if (msg.tools_used) {
                msg.tools_used.forEach((tool) => tools.add(tool));
            }
            if ((_a = msg.metadata) === null || _a === void 0 ? void 0 : _a.preferences) {
     ...
     */
    async createContextSummary(messages) {
        var _a, _b;
...
Format as JSON with these fields: summary, keyPoints, importantStocks, importantIndices, userPreferences, toolsUsed`;
        try {
            ...
            let summaryText = ((_b = (_a = response.choices[0]) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.content) || '{}';
            ...
            console.warn('AI summarization failed, using fallback method:', error instanceof Error ? error.message : String(error));
            return {
                summary: `Conversation with ${messages.length} messages about Indian stock market data`,
                keyPoints: keyInfo.queries.slice(0, 5),
     ...
     */
    async optimizeContext(messages, systemPrompt, maxTokens) {
        const tokenCount = this.countTokens(messages, systemPrompt);
     ...
     */
    async createSummarizedContext(messages, systemPrompt, maxTokens) {
     ...
     */
    async getOptimalContext(messages, systemPrompt, maxTokens) {
